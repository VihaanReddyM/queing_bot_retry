    ...
    if (oldState.channelId && !newState.channelId) {
      ...
      if (wasInQueue) {
        const embed = new EmbedBuilder()
          ...
          .setDescription(
            `You have been removed from the **${gameModes.join(
              ", "
            )}** queue(s) because you left the voice channel. We miss you already!`
          )
          .setColor("#FF0000")
          .setFooter({ text: "Rejoin a voice channel to queue up again! 😊" })
          .setTimestamp();
